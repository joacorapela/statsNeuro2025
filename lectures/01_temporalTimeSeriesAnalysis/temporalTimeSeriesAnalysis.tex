...
\begin{frame}
    \frametitle{Generation of time series}

    \begin{description}

        \item[generate white noise] the first step to generate time series is
            to generate \textbf{white noise} (i.e., independent Gaussian random
            variables with zero mean and fixed variance).
            ...
            \hreff{}{\includegraphics[width=2in]{../../examples/01_temporalTimeSeriesAnalysis/figures/whiteNoise.png}}

        \item[moving average models]

            \begin{align*}
                \nu_t = \frac{1}{3}(w_{t-1} + w_t + w_{t+1})
            \end{align*}
